...
<?php
    ...
    ?>
                ...
                <li><span class="logout"><a href="login.php">Login</a></span> </li>

                <li>  <span class="logout"><a href="registration.php">Registration</a></span> </li>
    ...
    <section id="menu" class="menu section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row menu-container" data-aos="fade-up" data-aos-delay="200">
            <?php
            $query = "SELECT m.name, m.price, m.contains, m.img_url, mt.type FROM menu AS m LEFT JOIN menu_types AS mt ON m.type = mt.id";
            $result = mysqli_query($conn, $query);
            if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                ?>
                <div class="col-lg-6 menu-item filter-<?=$row['type']?>">
                    <img src="<?=$row['img_url']?>" class="menu-img" alt="">
